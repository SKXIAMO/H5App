<template>
  <div class="agreement-page">
    ...
    <div class="agreement-content">
      ...
      <p>
        Welcome to <strong>Tenao</strong>! Tenao is a social platform designed for dance enthusiasts to connect, learn, and share their passion through innovative features including a vibrant community, AI-powered assistance, and engaging short video tutorials. Before using Tenao, please read this User Agreement carefully. By accessing or using Tenao, you agree to comply with this agreement and all applicable laws.
      </p>

      <h2>1. Project Description</h2>

      <p>
        Tenao aims to create a global community where dancers of all levels can interact, inspire each other, and grow together. Our platform integrates social networking, AI technology, and multimedia content to enhance your dance experience.
      </p>
      ...
      <p>
        By using Tenao, you agree to engage respectfully, provide accurate information, and adhere to all applicable laws and platform guidelines.
      </p>

      <h2>6. Content Guidelines</h2>

      <p>
        All shared content must be appropriate and lawful. Tenao reserves the right to remove content that violates these guidelines or the User Agreement.
      </p>
      ...
      <p>
        Tenao may suspend or terminate your account if you violate this agreement or engage in harmful behavior.
      </p>
      ...
      <h2>11. Join Tenao Today!</h2>

      <p>
        Embrace your passion for dance and connect with a global community. Download Tenao and start your dance journey now!
      </p>
